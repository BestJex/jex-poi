...
import com.jex.config.properties.MasterProperties;
import com.jex.config.properties.SlaveProperties;
 ...
 */
@Configuration
@MapperScan(value = "com.jex.mapper")
@EnableTransactionManagement(order = 2)//由于引入多数据源，所以让spring事务的aop要在多数据源切换aop的后面
@ComponentScan({"com.jex.config"})
